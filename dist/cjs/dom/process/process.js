...
const process_js_1 = require("../../object/process/process.js");
 ...
 * @returns
 */
function process(element, action, options) {
    if (element instanceof DocumentFragment) {
        for (let child of element.children)
            process(child, action, options);
    }
    return (0, process_js_1.process)(element.children, processAction(action, options), ...(options?.args || []));
}
