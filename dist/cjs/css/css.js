...
exports.wrap = exports.StyleSheet = exports.selectFirst = exports.selectAll = exports.popStyles = exports.popAttrs = exports.loadStyle = exports.createStyle = void 0;
/**
 ...
 */
async function loadStyle(href, init) {
...
function* popStyles(...elements) {
    for (let element of elements) {
        if ((element.getAttribute("rel") === "stylesheet" && element.hasAttribute('href')) || element instanceof HTMLStyleElement) {
            ...
            if (!element.hasAttribute(exports.popAttrs.keep))
                element.remove();
        }
        else {
 ...
 */
function* selectAll(selectors, styleSheet) {
 ...
 */
function selectFirst(selectors, styleSheet) {
