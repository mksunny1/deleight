...
exports.asyncTemplates = exports.templates = exports.asyncTemplate = exports.template = exports.asyncTag = void 0;
/**
 ...
 */
async function asyncTag(strings, ...expressions) {
 ...
 * @returns {ITemplates}
 */
function templates(templateStr, argNames = ['iter'], itemName = 'item') {
    return (Function(`
 ...
 */
function asyncTemplates(templateStr, argNames = ['iter'], itemName = 'item', tagName = 'T') {
    if (itemName === tagName) {
