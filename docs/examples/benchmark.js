...
class Component {
    ...
    append(n) {
        ...
        for (let i = a; i < z; i++) {
            ...
            mk.push(`<tr><td class='col-md-1'>${i}</td><td class='col-md-4'><a class='lbl'>${lbl}</a></td><td class='col-md-1'><a class='remove'><span class='remove glyphicon glyphicon-remove' aria-hidden='true'></span></a></td><td class='col-md-6'></td></tr>`);
        }
        this.parent.appendChild(createFragment(mk.join('')));
    }
    swap() {
