...
import { set } from "../../src/queryoperator.js";
...
apply({
    tbody: (table) => {
        ...
        apply({
            "#run": btnListener((e) => component.create(1000)),
            "#runlots": btnListener((e) => component.create(10000)),
            "#add": btnListener((e) => component.append(1000)),
            "#update": btnListener((e) => component.update()),
            "#clear": btnListener((e) => component.clear()),
            "#swaprows": btnListener((e) => component.swap()),
        });
    },
});
